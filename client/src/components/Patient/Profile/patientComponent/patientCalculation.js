      ...
      <Paper className={classes.root} elevation={1}>
        ...
        <Paper className={classes.root2} elevation={1}>
          <Typography component="p" >
            ...
            {!(props.patient.PhysicalExamination.length == 0) &&  <i className={classes.content}>{ Math.round((props.patient.PhysicalExamination[0].weight / Math.pow(props.patient.PhysicalExamination[0].height, 2)) * 10000) + ' BMI'}</i>}
          </Typography>
        </Paper>
        <Paper className={classes.root2} elevation={1}>
          <Typography component="p1" >
            ...
            {!(props.patient.PhysicalExamination.length == 0) && <i className={classes.content}>{props.patient.PhysicalExamination[0].diabetes+' D'}</i>}
          </Typography>
        </Paper>
        ...
        <Paper className={classes.root2} elevation={1}>
          <Typography component="p1" >
            ...
            {!(props.patient.PhysicalExamination.length == 0) && <i className={classes.content}>{props.patient.PhysicalExamination[0].bodyTemperature+' °C'}</i>}
          </Typography>
        </Paper>
        <Paper className={classes.root2} elevation={1}>
          <Typography component="p1" >
